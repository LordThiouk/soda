...
export default function RapportsPage() {
  ...
  const filteredRapports = rapports.filter(rapport => {
    ...
    // Filtre par format
    if (selectedFormat && rapport.format !== selectedFormat) {
      return false;
    }
    // Filtre par période/type
    if (selectedPeriode && rapport.type !== selectedPeriode) {
      return false;
    }
    return true;
  });
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedFormat(value || null)}
                  >
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedPeriode(value || null)}
                  >
